...
public class UserLogin implements PropertyBusinessObject {
      ...
      public final Property<String, UserLogin> password = new Property<>("password");

    private final PropertyIndex idx = new PropertyIndex(this, "UserLogin", username, password);
